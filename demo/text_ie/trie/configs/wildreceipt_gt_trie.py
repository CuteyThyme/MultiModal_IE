# model settings
character = 'demo/text_ie/datalist/wildreceipt/flatten_dict.txt'
batch_max_length = 60
type="SPOTTER"
model = dict(
    type='TRIEGT',
    pretrained='demo/text_ie/trie/resnet50-19c8e357.pth',
    backbone=dict(
        type='ResNet',
        depth=50,
        num_stages=4,
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='demo/text_ie/datalist/wildreceipt/datalist_train.json',
        img_prefix='demo/text_ie/datalist/wildreceipt/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file='demo/text_ie/datalist/wildreceipt/datalist_test.json',
        img_prefix='demo/text_ie/datalist/wildreceipt/',
        pipeline=test_pipeline,
        classes='demo/text_ie/datalist/wildreceipt/class_list.txt'),
    test=dict(
        type=dataset_type,
        ann_file='demo/text_ie/datalist/wildreceipt/datalist_test.json',
        img_prefix='demo/text_ie/datalist/wildreceipt/',
...
log_level = 'INFO'
work_dir = 'demo/text_ie/trie/log/wildreceipt_gt_trie'
load_from = None
resume_from = None
workflow = [('train', 1)]
